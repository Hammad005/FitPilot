...
const GenerateProgram = () => {
  ...
  useEffect(() => {
    ...
    const handleSpeechEnd = () => {
      console.log("Ai is not speaking");
      setIsSpeaking(false);
    }
      ...
      <div className='container mx-auto px-4 h-full max-w-5xl'>
        <div className='text-center mb-8'>
          ...
          <p className='text-muted-foreground mt-2'>
            Have a voice conversation with AI assistant to create your personalized plan
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
          <Card className='bg-card/90 backdrop-blur-sm border border-border overflow-hidden relative'>
            <div className='aspect-video flex flex-col items-center justify-center p-6 relative'>
              ...
              <h2 className='text-xl text-foreground'>FitPilot AI</h2>
              ...
              <div className={`mt-4 flex items-center gap-2 px-3 py-1 rounded-full bg-card border border-border ${isSpeaking ? "border-primary" : ""}`}>
                <div
                  className={`size-2 rounded-full ${isSpeaking ? "bg-primary animate-pulse" : "bg-muted"}`}
                />
                ...
                callEnded && (
                  <div className='message-item animate-fadeIn'>
                    ...
                    <p className='text-foreground'>
                      Your fitness program has been created! Redirecting you to your profile...
                    </p>
                  </div>
                )
              }
        ...
        <div className='w-full flex justify-center gap-4'>
          <Button
            ...
            className={`w-40 text-xl rounded-3xl ${callActive ? "bg-destructive hover:bg-destructive/90" : callEnded ? "bg-green-600 hover:bg-green-700" : "bg-primary hover:bg-primary/90"} text-white relative`}
          >
            {connecting && (
              <span className='absolute inset-0 rounded-full animate-ping bg-primary/90 opacity-75' />
            )}
            <span>
